...
# Versión activa: V37.66 · Última actualización: 2026-09-03 (fix ventas-manzano*.json a data/<token>/ en main.py + descargar_ventas_erp.py — septiembre no aparecía en Análisis/Ventas por Vendedor)
