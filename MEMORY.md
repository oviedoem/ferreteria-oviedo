...
Carpeta archivados: E:\ferreteria-oviedo\_ARCHIVADOS\  (scripts obsoletos prefijo YYYYMMDD_)
Carpeta historico:  E:\ferreteria-oviedo\_HISTORICO\  (MDs historicos)
...
ESTADO_PROYECTO.md: E:\ferreteria-oviedo\ESTADO_PROYECTO.md
```

REGLA: Nunca trabajar en E:\ferreteria-oviedo-github\ (no existe). Nunca en E:\git-sync\ directamente.
...
- Log: E:\ferreteria-oviedo\logs\auto_YYYYMMDD_HH00.log
